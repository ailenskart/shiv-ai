...
export const TABS: Record<TabId, TabConfig> = {
  shiv: {
    ...
    inputPlaceholder: "Ask Shiv.ai anything...",
  ...
  gita: {
    ...
    inputPlaceholder: "Ask Gita.ai anything...",
  ...
  veda: {
    ...
    placeholder: "Ask about the Vedas...",
    ...
    inputPlaceholder: "Ask Veda.ai anything...",
  ...
  buddha: {
    ...
    inputPlaceholder: "Ask Buddha.ai anything...",
