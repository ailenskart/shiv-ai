...
export const TABS: Record<TabId, TabConfig> = {
  ...
  sikh: {
    ...
    placeholder: "Ask about Sikh wisdom, Gurbani, the Ten Gurus...",
    buttonLabel: "Ask Guru",
    footerMantra: "\u{2764}\uFE0F Waheguru Ji Ka Khalsa, Waheguru Ji Ki Fateh \u{2764}\uFE0F",
    footerText: "Powered by 1,430 pages of Guru Granth Sahib & Sikh traditions",
    exploreLabel: "Explore Sikh Wisdom",
    chatSubtitle: "The Complete Guru Granth Sahib & Sikh Knowledge Library",
    inputPlaceholder: "Ask anything \u2014 powered by Sikh wisdom...",
    sourceLine: "Sources: Guru Granth Sahib, Ten Gurus, Sikh History & Philosophy",
    color: "#FF6B00",
  },
  torah: {
    id: "torah",
    ...
    placeholder: "Ask about Torah, Talmud, Kabbalah, Jewish wisdom...",
    buttonLabel: "Ask Torah",
    footerMantra: "\u2721\uFE0F Shema Yisrael, Adonai Eloheinu, Adonai Echad \u2721\uFE0F",
    footerText: "Powered by Torah, Talmud, Kabbalah & 3,500+ years of Jewish wisdom",
    exploreLabel: "Explore Torah Wisdom",
    chatSubtitle: "The Complete Torah & Jewish Knowledge Library",
    inputPlaceholder: "Ask anything \u2014 powered by Torah wisdom...",
    sourceLine: "Sources: Torah, Talmud, Kabbalah, Jewish Philosophy",
    color: "#1E40AF",
  },
  tao: {
    id: "tao",
    ...
    placeholder: "Ask about Tao, Wu Wei, Confucius, I Ching...",
    buttonLabel: "Ask Tao",
    footerMantra: "\u262F The Tao that can be told is not the eternal Tao \u262F",
    footerText: "Powered by Tao Te Ching, Analects, I Ching & 2,500+ years of wisdom",
    exploreLabel: "Explore Taoist Wisdom",
    chatSubtitle: "The Complete Taoist & Eastern Philosophy Library",
    inputPlaceholder: "Ask anything \u2014 powered by Taoist wisdom...",
